...
from gripper3 import GRIPPER3_ASSERT_DIR
from gripper3.utils import BaseConfig

try:
    from gripper3.gaussian_renderer import GSRenderer
    from gripper3.gaussian_renderer.util_gau import multiple_quaternion_vector3d, multiple_quaternions
...
class SimulatorBase:
    ...
    def __init__(self, config:BaseConfig):
        ...
        if self.config.mjcf_file_path.startswith("/"):
            ...
            self.mjcf_file = os.path.join(GRIPPER3_ASSERT_DIR, self.config.mjcf_file_path)
