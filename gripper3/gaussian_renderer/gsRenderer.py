...
from gripper3.gaussian_renderer import util_gau
from gripper3.gaussian_renderer.renderer_cuda import CUDARenderer
...
class GSRenderer:
    def __init__(self, models_dict:dict, render_width=1920, render_height=1080):
        ...
        gs_model_dir = Path(os.path.join(GRIPPER3_ASSERT_DIR, "3dgs"))
