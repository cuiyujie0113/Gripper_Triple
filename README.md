...
0. Hardware wiring
    ...
    - The sequence of the four pins on the string board is as shown in the figure, with the silkscreen number mark.
    - <img src="images/encoder2connector.png" alt="line" width="500">
